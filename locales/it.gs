  ...
  return Object.freeze({
    ...
    reportLabels: Object.freeze({
      ...
      failureStages: Object.freeze({
        ...
        'validating-service-identity': 'Verifica intestatario e indirizzo',
    ...
    headerAliases: Object.freeze({
      ...
      accountHolder: ['intestatario', 'intestatario fattura', 'nome cliente', 'titolare utenza'],
      serviceAddress: ['indirizzo di fornitura', 'indirizzo servizio', 'indirizzo utenza'],
