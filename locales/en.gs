...
function getEnglishLocalization_() {
  return Object.freeze({
    ...
    serviceIdentityControls: Object.freeze({
      accountHolderPlaceholder: 'Enter account holder here',
    ...
    reportLabels: Object.freeze({
      ...
      failureStages: Object.freeze({
        ...
        'validating-service-identity': 'Verifying account holder and service address',
    ...
    headerAliases: Object.freeze({
      ...
      accountHolder: ['account holder', 'customer name', 'subscriber name'],
      serviceAddress: ['service address', 'supply address', 'utility address'],
